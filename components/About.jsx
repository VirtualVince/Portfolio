    ...
    <div id="about" className="w-full md:h-screen p-2 flex items-center">
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2">
          <p className="py-4 uppercase text-xl tracking-widest text-accent">
            About
          </p>
          <h2 className="py-4 uppercase text-xl tracking-widest text-content">
            Who I am
          </h2>
          <p className="py-2 text-muted">
            I build and run websites and web apps for clients through my business,{" "}
            <span className="font-semibold text-content">Virtual Vince</span>.
          ...
          <p className="py-2 text-muted">
            ...
            co-founded{" "}
            <span className="font-semibold text-content">Orpheus</span>,
          ...
          <p className="py-2 text-muted">
            Check out my{" "}
            <Link href="/resume">
              <span className="text-accent hover:underline"> resume </span>
            </Link>{" "}
            or browse my{" "}
            <Link href="/#projects">
              <span className="text-accent hover:underline"> client work </span>
            </Link>
            .
          </p>
        </div>
